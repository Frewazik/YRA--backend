...
class TeacherProfile(models.Model):
    ...
    user = models.OneToOneField(
        User,
        on_delete=models.CASCADE,  # если удалить юзера, то удаляется и привязанный профиль
...
class Activity(models.Model):
    ...
    CATEGORY_CHOICES = [("CLUB", "Кружок"), ("SERVICE", "Услуга")]
...
class ScheduleException(models.Model):
    TYPE_CHOICES = [("CANCELLATION", "Отмена"), ("RESCHEDULE", "Перенос")]
...
class Attendance(models.Model):
    ...
    slot = models.ForeignKey(WeeklySlot, on_delete=models.SET_NULL, null=True, verbose_name="Урок")
...
class Subscription(models.Model):
    ...
    plan = models.ForeignKey(SubscriptionPlan, on_delete=models.PROTECT, verbose_name="Тариф")
...
class Transaction(models.Model):
    ...
    plan = models.ForeignKey("SubscriptionPlan", on_delete=models.SET_NULL, null=True, verbose_name="Тариф")
