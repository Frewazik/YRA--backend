...
class LeadCaptureView(APIView):
    def post(self, request):
        ...
        parent, created_parent = Parent.objects.get_or_create(phone=phone, defaults={"full_name": parent_name})
        ...
        Transaction.objects.create(parent=parent, amount=0, status="PENDING", comment=comments)
