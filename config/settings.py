...
# Добавляем папку apps в пути поиска, чтобы Django видел наши приложения
...
SECRET_KEY = "django-insecure-te=v(+d*m_mw=^w$547_vr(d=$l@_3$2*nthdu6uz6)$9-ikd1"
...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 6,
    "EXCEPTION_HANDLER": "apps.services.exceptions.strict_exception_handler",
}
